                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Dashboard222222222</li>
                        </ul><!-- /.breadcrumb -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="alert alert-block alert-info">
                                    ...
                                    ยินดีต้อนรับ
                                    <strong class="green">
                                        คุณจิรวัฒน์  ยาทองไชย
                                        <small>(srimuang)</small>
                                    </strong>,
                                    เข้าสู่โปรแกรมบริหารงานบุคคล โรงพยาบาลโคกศรีสุพรรณ <a href="https://github.com/bopoda/ace">github</a> (with minified ace js/css files).
                                </div>
